...
"[project]/pages/itinerary/[id]/edit.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditItinerary.useEffect": ()=>{
            ...
            fetch(`${apiUrl}/itineraries/${id}`, {
                ...
                "EditItinerary.useEffect": (r)=>{
                    if (!r.ok) throw new Error('Failed to fetch');
                    return r.json();
                }
            }["EditItinerary.useEffect"]).then({
                "EditItinerary.useEffect": (data)=>setItinerary(data)
            }["EditItinerary.useEffect"]).catch({
                "EditItinerary.useEffect": (e)=>{
                    console.error(e);
                    setItinerary(null);
                }
            }["EditItinerary.useEffect"]).finally({
                "EditItinerary.useEffect": ()=>setLoading(false)
            }["EditItinerary.useEffect"]);
        }
    }["EditItinerary.useEffect"], [
        id,
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        Array.isArray(itinerary.day_plans) && itinerary.day_plans.map((d, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                style: {
                                                    marginBottom: 12
                                                },
                                                children: [
...
_s(EditItinerary, "aOlraIn2ZhddG3X5ix7cRUogW3o=", false, function() {
    return [
...
_c = EditItinerary;
var _c;
__turbopack_context__.k.register(_c, "EditItinerary");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/itinerary/[id]/edit.js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/itinerary/[id]/edit";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/itinerary/[id]/edit.js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/pages/itinerary/[id]/edit.js\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/itinerary/[id]/edit.js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__8dcaef28._.js.map